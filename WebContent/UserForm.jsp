...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <input type="text" class="form-control" id="exampleformcontrolInput1"  placeholder="Enter the name" name="name" style="width:300px">
    </div>
     <div class="mb-3">
      <label for="exampleformcontrolInput2" class="form-label">Email</label>
      <input type="text" class="form-control" id="exampleformcontrolInput2"  placeholder="Enter the email" name="email" style="width:300px">
    </div>
     <div class="mb-3">
      <label for="exampleformcontrolInput3" class="form-label">City</label>
      <input type="text" class="form-control" id="exampleformcontrolInput3"  placeholder="Enter the city" name="city" style="width:300px">
    </div>
    <div class="mb-3">
